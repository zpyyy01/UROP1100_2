 ...
 * Git version: 30dccd7
 * Options:   --seed 1024123628 --main --output compilable_codes/code_79.c
 * Seed:      1024123628
 */
...
static const uint8_t  func_1(void)
{ /* block id: 0 */
    const struct S0 *l_3 = &g_4;
    const struct S0 **l_2 = &l_3;
    const int32_t l_5[1][6] = {{0xFE04822BL,0xFE04822BL,0xFE04822BL,0xFE04822BL,0xFE04822BL,0xFE04822BL}};
    int i, j;
    (*l_2) = (void*)0;
    return l_5[0][5];
}
