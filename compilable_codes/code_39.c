 ...
 * Git version: 30dccd7
 * Options:   --seed 835363462 --main --output compilable_codes/code_39.c
 * Seed:      835363462
 */
...
static int64_t g_7 = 0xF38C08872FA4AD74LL;
static volatile uint32_t g_11 = 0x505B0BB8L;/* VOLATILE GLOBAL g_11 */
...
{ /* block id: 0 */
    ...
    for (i = 0; i < 6; i++)
        l_10[i] = &g_4;
    (*l_5) = (safe_lshift_func_uint8_t_u_s((g_4 ^ 0L), 7));
    ++g_11;
    return g_7;
}
