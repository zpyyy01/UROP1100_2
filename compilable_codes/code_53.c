 ...
 * Git version: 30dccd7
 * Options:   --seed 671976677 --main --output compilable_codes/code_53.c
 * Seed:      671976677
 */
...
static int32_t g_10 = 0x2DAAB72BL;
...
static int32_t  func_1(void)
{ /* block id: 0 */
    int32_t l_8 = 0xF27D2703L;
    int32_t * volatile *l_12 = &g_9;
    int32_t * volatile **l_11 = &l_12;
    (*g_9) |= (safe_rshift_func_int16_t_s_s((safe_sub_func_int32_t_s_s((+g_7), (g_7 != l_8))), 11));
    (*l_11) = &g_9;
    return (*g_9);
}
