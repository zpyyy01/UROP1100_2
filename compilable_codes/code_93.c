 ...
 * Git version: 30dccd7
 * Options:   --seed 2466696415 --main --output compilable_codes/code_93.c
 * Seed:      2466696415
 */
...
/* --- GLOBAL VARIABLES --- */
static uint8_t g_2[6] = {0x89L,0x07L,0x89L,0x89L,0x07L,0x89L};
static volatile struct S1 g_4 = {-3,0x5954E3F1L,2277,163,-1,-32,211};/* VOLATILE GLOBAL g_4 */
...
{ /* block id: 0 */
    ...
    int i;
    g_4.f0 = ((g_2[1] <= (!(((g_4 , (safe_rshift_func_uint8_t_u_u(((l_7 , (g_9 = ((g_4.f4 && (g_4.f6 & g_2[1])) || 0UL))) > 0xD2F55126L), g_2[1]))) != 0x925F321EL) <= 0xEA0E402095D7C154LL))) != 0x6FC7L);
    return g_4.f6;
}
