 ...
 * Git version: 30dccd7
 * Options:   --seed 3023628570 --main --output compilable_codes/code_25.c
 * Seed:      3023628570
 */
...
/* --- GLOBAL VARIABLES --- */
static int32_t g_2[7] = {(-7L),0x16EFA42BL,(-7L),(-7L),0x16EFA42BL,(-7L),(-7L)};
static int32_t g_9 = 0x9B2E4145L;
...
{ /* block id: 0 */
    ...
    for (i = 0; i < 2; i++)
        l_12[i] = &g_2[2];
    for (g_2[2] = 0; (g_2[2] != (-21)); g_2[2] = safe_sub_func_int32_t_s_s(g_2[2], 7))
    { /* block id: 3 */
        int32_t l_5 = (-5L);
        if (l_5)
            break;
        for (l_5 = 22; (l_5 < 3); --l_5)
        { /* block id: 7 */
            (*g_8) |= g_2[2];
            if ((*g_8))
                break;
